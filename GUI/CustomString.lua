...
StdUi:RegisterWidget("DraduxTodo_CustomString", function(self, parent, data)
    ...
    local input = StdUi:EditBox(widget, width_2, 24, data.value)
    widget.input = input
    ...
    function widget:SetData(data)
        ...
        widget.input:SetText(data.value or "")
